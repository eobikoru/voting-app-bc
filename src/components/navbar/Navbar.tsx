...
const Navbar = () => {
  ...
  const menu = (
    <Menu className="p-2">
      <Menu.Item key="1" icon={<HomeOutlined />} className="px-9 py-4 hover:bg-gray-100 rounded-md">
        <Link href="/" passHref>
          Home
        </Link>
      </Menu.Item>
      <Menu.Item key="4" icon={<UserAddOutlined />} className="px-9 py-4 w-60 h-10 hover:bg-gray-100 rounded-md">
        <Link href="/register-voter" passHref>
          Register a Voter
        </Link>
      </Menu.Item>
      <Menu.Item key="3" icon={<FileAddOutlined />} className="px-9 py-4 hover:bg-gray-100 rounded-md">
        <Link href="/create-proposal" passHref>
          Create Proposal
        </Link>
      </Menu.Item>
      <Menu.Item key="4" icon={<UnorderedListOutlined />} className="px-9 w-30 py-4 hover:bg-gray-100 rounded-md">
        <Link href="/proposals" passHref>
          List of Proposals
        </Link>
      </Menu.Item>
      <Menu.Item key="5" icon={<TeamOutlined />} className="px-9 py-4 hover:bg-gray-100 rounded-md">
        <Link href="/voters" passHref>
          List of Voters
        </Link>
      </Menu.Item>
      <Menu.Item key="6" icon={<TrophyOutlined />} className="px-9 py-4 hover:bg-gray-100 rounded-md">
